...
(function( factory ) {
	...
	function getDocs( location ) {
		...
		$.ajax( location, {
			...
			success: function( data ) {
				...
				$( docs ).find( "[type='widget']").each( function() {
					...
					$( this ).find( "event" ).each( function() {
						widgets[ title ][ $( this ).attr( "name" ) ] = {
							...
							"warning" : $( this ).find( ".warning" ).text()
						};
				...
				//alert(widgets["button"].create.name);
	...
	$.mobile.eventLogger = function( userOptions ) {
		...
		getDocs( userOptions.location || options.location );
...
*/
			console.log("jqmed:"+JSON.stringify(message));
